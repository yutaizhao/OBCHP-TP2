...
```{r}
png(file = "dotprod mbps (clang).png", width = 1920, height = 1080, units = "px", res = 300)
...
```{r}
png(file = "dotprod mbps (gcc).png", width = 1920, height = 1080, units = "px", res = 300)
...
png(file = "dotprod mbps (base).png", width = 1920, height = 1080, units = "px", res = 300)
barplot(t(as.matrix(data)), beside = TRUE, col = terrain.colors(2), xlab = "Flags", ylab = "Mbps", ylim =c(0,20000)) 
...
png(file = "dotprod mbps (unroll).png", width = 1920, height = 1080, units = "px", res = 300)
barplot(t(as.matrix(data)), beside = TRUE, col = terrain.colors(2), xlab = "Flags", ylab = "Mbps", ylim =c(0,20000)) 
...
```{r}
png(file = "dotprod stddev (gcc).png", width = 1920, height = 1080, units = "px", res = 300)
barplot(t(as.matrix(data)), beside = FALSE, col = heat.colors(5), xlab = "n-ème exécution", ylab = "stddev", ylim =c(0,100)) 

title("dotprod stddev (gcc)")
legend("topleft", colnames(data), cex = 0.5, bty = "n", fill = heat.colors(5))
 dev.off()
```
